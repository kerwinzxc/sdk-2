...
public abstract class HttpCallbackDecode<E> extends HttpCallback {
    ...
    public HttpCallbackDecode(Context activity) {
    ...
    public final void onSuccess(String t) {
        ...
        try {
            ...
            if (code == 1) {
                ...
                T.s(activity, msg /*+ "  错误码：" + code*/);
                onDataFailure(dataObject);
            }
...
//                                    //账号过期，退出登陆
//                                    HuosdkManager.getInstance().logoutExecute(OnLogoutListener.TYPE_TOKEN_INVALID);
//                                }
//                                @Override
...
//            onFailure("-1", "服务器忙，请稍后再试");
     ...
     */
    @NotProguard
    public abstract void onDataFailure(E data);
