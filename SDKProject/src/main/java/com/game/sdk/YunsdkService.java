...
public class YunsdkService extends Service {
...
//            Intent intent_service = new Intent(ctx, YunsdkService.class);
//            intent_service.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            ctx.startForegroundService(intent_service);
//        } else {
//            Intent intent_service = new Intent(ctx, YunsdkService.class);
//            intent_service.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//        }
    ...
    public void onCreate() {
        super.onCreate();
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//            startForeground(111,new Notification()); //这个id不要和应用内的其他同志id一样，不行就写 int.maxValue()        //context.startForeground(SERVICE_ID, builder.getNotification());
//        }
        //适配8.0service
        NotificationManager notificationManager = (NotificationManager) this.getSystemService(Context.NOTIFICATION_SERVICE);
        NotificationChannel mChannel = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            mChannel = new NotificationChannel(CHANNEL_ID_STRING, "下载",
