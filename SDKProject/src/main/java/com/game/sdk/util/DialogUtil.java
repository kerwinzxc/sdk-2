...
//                "yun_sdk_customDialog"));

//        dialog = new Dialog(context, R.style.yun_sdk_customDialog);
//
//        view = LayoutInflater.from(context).inflate(R.layout.yun_sdk_dialog_loading, null);
//        iv_pd = (ImageView) view.findViewById(R.id.yun_sdk_iv_circle);
//        dialog.setCancelable(false);
//        dialog.setCanceledOnTouchOutside(false);
//        tv_msg = (TextView) view.findViewById(R.id.yun_sdk_tv_msg);
//        dialog.setContentView(view);

        dialog = new Dialog(context, MResource.getIdByName(context, "style",
                "yun_sdk_customDialog"));
        view = LayoutInflater.from(context).inflate(
                MResource.getIdByName(context, "layout", "yun_sdk_dialog_loading"), null);
        iv_pd = (ImageView) view.findViewById(MResource.getIdByName(context,
                "id", "yun_sdk_iv_circle"));
        dialog.setCancelable(false);
        dialog.setCanceledOnTouchOutside(false);
